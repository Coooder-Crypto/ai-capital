...
```bash
export DATABASE_URL='<database_url>'
export ADMIN_REVIEW_SESSION_SECRET='<admin_review_session_secret>'
export ADMIN_REVIEW_ADMIN_PASSWORD='<admin_review_admin_password>'
export ADMIN_REVIEW_REVIEWER_PASSWORD='<admin_review_reviewer_password>'
export LLM_EXTRACT_URL='<llm_extract_url>'
export LLM_EXTRACT_API_KEY='<llm_extract_api_key>'

gh secret set DATABASE_URL --body "$DATABASE_URL"
gh secret set ADMIN_REVIEW_SESSION_SECRET --body "$ADMIN_REVIEW_SESSION_SECRET"
gh secret set ADMIN_REVIEW_ADMIN_PASSWORD --body "$ADMIN_REVIEW_ADMIN_PASSWORD"
gh secret set ADMIN_REVIEW_REVIEWER_PASSWORD --body "$ADMIN_REVIEW_REVIEWER_PASSWORD"
gh secret set LLM_EXTRACT_URL --body "$LLM_EXTRACT_URL"
gh secret set LLM_EXTRACT_API_KEY --body "$LLM_EXTRACT_API_KEY"
```
...
```bash
export ADMIN_REVIEW_TOKEN='<admin_review_token>'
export ADMIN_REVIEW_ADMIN_TOKEN='<admin_review_admin_token>'
export ADMIN_REVIEW_REVIEWER_TOKEN='<admin_review_reviewer_token>'

gh secret set ADMIN_REVIEW_TOKEN --body "$ADMIN_REVIEW_TOKEN"
gh secret set ADMIN_REVIEW_ADMIN_TOKEN --body "$ADMIN_REVIEW_ADMIN_TOKEN"
gh secret set ADMIN_REVIEW_REVIEWER_TOKEN --body "$ADMIN_REVIEW_REVIEWER_TOKEN"
```

## GitHub Variables

```bash
gh variable set LLM_EXTRACT_MODEL --body "http-extract-model"
gh variable set LLM_EXTRACT_RPM --body "30"
gh variable set LLM_EXTRACT_MAX_RETRIES --body "2"
gh variable set LLM_EXTRACT_RETRY_BASE_MS --body "1000"
```
